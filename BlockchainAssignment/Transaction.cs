...
namespace BlockchainAssignment
{
    class Transaction
    {
        ...
        public Transaction(String fromSender, String toRecipient, double amount, double fee, String privateKey)
        {

            this.senderAddress = fromSender;
            this.recipientAddress = toRecipient;
            this.amount = amount;
            this.fees = fee;
            ...
            this.signature = Wallet.Wallet.CreateSignature(fromSender, privateKey, this.hash);
